...
// CheckChangePasswordUsingIdAndIPAddress
// Check to see if the user must obtain a Trust Token Id in order to complete a change password request.
// When a user has enabled Two-Factor authentication, before you are allowed to use the Change Password API to change
// your password, you must obtain a Trust Token by completing a Two-Factor Step-Up authentication.
//
...
func (c *FusionAuthClient) CheckChangePasswordUsingIdAndIPAddress(changePasswordId string, ipAddress string) (*BaseHTTPResponse, *Errors, error) {
	return c.CheckChangePasswordUsingIdAndIPAddressWithContext(context.TODO(), changePasswordId, ipAddress)
}

// CheckChangePasswordUsingIdAndIPAddressWithContext
// Check to see if the user must obtain a Trust Token Id in order to complete a change password request.
// When a user has enabled Two-Factor authentication, before you are allowed to use the Change Password API to change
// your password, you must obtain a Trust Token by completing a Two-Factor Step-Up authentication.
//
...
//	string changePasswordId The change password Id used to find the user. This value is generated by FusionAuth once the change password workflow has been initiated.
//	string ipAddress (Optional) IP address of the user changing their password. This is used for MFA risk assessment.
func (c *FusionAuthClient) CheckChangePasswordUsingIdAndIPAddressWithContext(ctx context.Context, changePasswordId string, ipAddress string) (*BaseHTTPResponse, *Errors, error) {
	var resp BaseHTTPResponse
	var errors Errors
